...
GlobalVariable.LicenseNumber = WebUI.getText(findTestObject('Organization Emploee_Home Page/Projects Services/Internal Bank Account Approval/span_license number field'))
...
WebUI.verifyTextPresent(GlobalVariable.AccountNo1, false, FailureHandling.OPTIONAL)

WebUI.verifyTextPresent(GlobalVariable.AccountNo2, false, FailureHandling.OPTIONAL)
