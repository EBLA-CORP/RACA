...
GlobalVariable.LicenseNumber = WebUI.getText(findTestObject('Organization Emploee_Home Page/Collection Services/Collection Services/span_License number'))

WebUI.click(findTestObject('Organization Emploee_Home Page/Collection Services/Collector Approval/License Number'))

WebUI.delay(5)

WebUI.verifyTextPresent(GlobalVariable.LicenseNumber, false, FailureHandling.OPTIONAL)

WebUI.verifyTextPresent('إلغاء', false, FailureHandling.OPTIONAL)

WebUI.verifyTextPresent(GlobalVariable.CollectionServicesType, false, FailureHandling.OPTIONAL)
