...
WebUI.click(findTestObject('Organization Emploee_Home Page/Collection Services/Collection Services/button_accept(for update and cancel request form reset)'))
...
'رقم الرخصة'
WebUI.setText(findTestObject('Organization Emploee_Home Page/Collection Services/Collection Services/input__OldLicenseFullSerial'), 
    GlobalVariable.LicenseNumber)

WebUI.delay(2)

WebUI.sendKeys(findTestObject('Organization Emploee_Home Page/Collection Services/Collection Services/input__OldLicenseFullSerial'), 
    Keys.chord(Keys.ENTER))
