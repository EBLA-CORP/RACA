...
switch (GlobalVariable.RemittanceUser) {
    case GlobalVariable.switch_RemittanceUser1:
        WebUI.callTestCase(findTestCase('تسجيل الدخول/تسجيل دخول موظف تحويلات بنكية 1'), [:], FailureHandling.STOP_ON_FAILURE)

        break
    case GlobalVariable.switch_RemittanceUser2:
        WebUI.callTestCase(findTestCase('تسجيل الدخول/تسجيل دخول موظف تحويلات بنكية 2'), [:], FailureHandling.STOP_ON_FAILURE)
...
'تاريخ بدء العمل'
WebUI.click(findTestObject('Licensing Specialist/User Inbox/div__licenseEndDate'), FailureHandling.STOP_ON_FAILURE)
