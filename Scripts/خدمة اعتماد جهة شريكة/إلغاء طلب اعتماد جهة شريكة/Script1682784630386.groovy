...
'نوع الطلب'
WebUI.setText(findTestObject('Organization Emploee_Home Page/Partner Approval/input__requestType'), 'إلغاء')

WebUI.sendKeys(findTestObject('Organization Emploee_Home Page/Partner Approval/input__requestType'), Keys.chord(Keys.ENTER))

WebUI.delay(2)

'إدخال رقم الرخصة للطلب المراد إلغاؤه'
WebUI.setText(findTestObject('Organization Emploee_Home Page/Partner Approval/input__oldLicenseFullSerial (1)'), GlobalVariable.LicenseNumber)

WebUI.delay(1)

WebUI.sendKeys(findTestObject('Organization Emploee_Home Page/Partner Approval/input__oldLicenseFullSerial (1)'), Keys.chord(
        Keys.ENTER))
