...
GlobalVariable.LicenseNumber = WebUI.getText(findTestObject('Organization Emploee_Home Page/Collection Services/Collector Approval/span_License Number (new)'))
